# mirctl 0.1.0 for macOS arm64

This package contains the Godot Game Stream desktop viewer. It requires
...
The supported host is Godot 4.6.2 with Forward+ and Metal. Close the viewer window
